...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("stabilityshares-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("stabilityshares-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("stabilityshares-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "StabilityShares " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"stabilityseedxsi.blockxplorer.com", "stabilityseedxsi.blockxplorer.com"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("stabilityshares-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("stabilityshares-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("stabilityshares-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("stabilityshares-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. StabilityShares is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("stabilityshares-start");
