...
# OSX build dependencies - uncomment for building on osx
...
# Windows build dependencies - uncomment for building on windows using mingw
# BOOST_LIB_SUFFIX=-mgw46-mt-sd-1_55
# BOOST_INCLUDE_PATH=C:/deps/boost_1_55
# BOOST_LIB_PATH=C:/deps/boost_1_55/stage/lib
...
contains(USE_QRCODE, 1) {
	...
	LIBS += $$join(QRENCODE_LIB_PATH,,-L,) -lqrencode -lpthread
}
...
macx:TARGET = "StabilitySharesXSI-Qt"
